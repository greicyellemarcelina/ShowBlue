<?php
    ...
    $rs = $db->query("SELECT ticket.nome, ticket.cpf, ticket.data, evento.nome AS evento, evento.valor AS valor 
    FROM ticket INNER JOIN evento
    ON ticket.nome LIKE '%".$busca."%' OR ticket.cpf LIKE '%".$busca."%' 
    OR ticket.data LIKE '%".$busca."%'" );
	...
	<body>
     <div id="topo" style="position: absolute; z-index: 999999">  
        ...
        <div class="pull-right">
                <a href="sair.php" class="btn btn-danger" style="position: absolute; z-index: 999999; right: 20px; top: 20px">
                    Sair
                </a>
         </div>             
